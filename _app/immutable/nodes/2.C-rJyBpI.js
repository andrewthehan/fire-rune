import{f as _,a as y}from"../chunks/CezTi1ZY.js";import{h as $,O as k,P as te,Q as t,R as ne,S as f,T as o,V as n,W as se}from"../chunks/D4jfyfa9.js";import{d as re}from"../chunks/Bp2uDD6Z.js";import{i as b}from"../chunks/SOrvEfh6.js";const H=[...` 	
\r\f \v\uFEFF`];function oe(l,e,h){var a=""+l;if(h){for(var u in h)if(h[u])a=a?a+" "+u:u;else if(a.length)for(var v=u.length,c=0;(c=a.indexOf(u,c))>=0;){var m=c+v;(c===0||H.includes(a[c-1]))&&(m===a.length||H.includes(a[m]))?a=(c===0?"":a.substring(0,c))+a.substring(m+1):c=m}}return a===""?null:a}function j(l,e,h,a,u,v){var c=l.__className;if($||c!==h||c===void 0){var m=oe(h,a,v);(!$||m!==l.getAttribute("class"))&&(m==null?l.removeAttribute("class"):l.className=m),l.__className=h}else if(v&&u!==v)for(var g in v){var F=!!v[g];(u==null||F!==!!u[g])&&l.classList.toggle(g,F)}return v}var ie=(l,e)=>k(e,"overview"),ae=(l,e)=>k(e,"auth"),le=(l,e)=>k(e,"firestore-doc"),ce=(l,e)=>k(e,"firestore-collection"),pe=(l,e)=>k(e,"stores"),de=(l,e)=>k(e,"typesafety"),ue=_(`<section id="overview" class="svelte-1ncwje1"><h2 class="svelte-1ncwje1">Overview</h2> <p>fire-rune provides reactive Svelte components to easily integrate Firebase Auth and
          ...
          multiple places.</p> <h3 class="svelte-1ncwje1">Available Stores</h3> <ul><li><code class="svelte-1ncwje1">userStore</code> - Reactive store for Firebase Auth user state</li> <li><code class="svelte-1ncwje1">documentStore</code> - Reactive store for a Firestore document</li> <li><code class="svelte-1ncwje1">collectionStore</code> - Reactive store for a Firestore collection query</li></ul> <h3 class="svelte-1ncwje1">Example with Svelte 5 Runes</h3> <pre class="svelte-1ncwje1">
					<code class="svelte-1ncwje1"></code></pre></section>`),we=_(`<section id="typesafety" class="svelte-1ncwje1"><h2 class="svelte-1ncwje1">Type Safety</h2> <p>fire-rune comes with full TypeScript support, ensuring that your Firestore data is
          properly typed throughout your application.</p> <h3 class="svelte-1ncwje1">Typed Documents</h3> <pre class="svelte-1ncwje1"><code class="svelte-1ncwje1"></code></pre> <h3 class="svelte-1ncwje1">Typed Collections</h3> <pre class="svelte-1ncwje1"><code class="svelte-1ncwje1"></code></pre> <h3 class="svelte-1ncwje1">ReadonlyWithId Type</h3> <p>The <code class="svelte-1ncwje1">ReadonlyWithId</code> type adds the document ID to your document type:</p> <pre class="svelte-1ncwje1"><code class="svelte-1ncwje1"></code></pre></section>`),ge=_('<main class="container svelte-1ncwje1"><header class="svelte-1ncwje1"><h1 class="svelte-1ncwje1">fire-rune 🔥</h1> <p>A lightweight, declarative Svelte library for Firebase integration</p> <div class="npm-badge svelte-1ncwje1"><code class="svelte-1ncwje1">npm install fire-rune firebase</code></div> <div class="badges svelte-1ncwje1"><a href="https://www.npmjs.com/package/fire-rune" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/npm/v/fire-rune.svg" alt="npm version"/></a> <a href="https://github.com/andrewthehan/fire-rune/blob/main/LICENSE" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="MIT License"/></a></div></header> <nav class="svelte-1ncwje1"><ul class="svelte-1ncwje1"><li><button>Overview</button></li> <li><button>Authentication</button></li> <li><button>Firestore Documents</button></li> <li><button>Firestore Collections</button></li> <li><button>Using Stores</button></li> <li><button>Type Safety</button></li></ul></nav> <div class="content"><!> <!> <!> <!> <!> <!></div> <footer class="svelte-1ncwje1"><p><a href="https://github.com/andrewthehan/fire-rune" target="_blank" rel="noopener noreferrer" class="svelte-1ncwje1">GitHub</a> | <a href="https://www.npmjs.com/package/fire-rune" target="_blank" rel="noopener noreferrer" class="svelte-1ncwje1">NPM</a> | <span>MIT License</span></p></footer></main>');function ke(l){let e=te("overview");var h=ge(),a=o(t(h),2),u=t(a),v=t(u),c=t(v);c.__click=[ie,e];let m;n(v);var g=o(v,2),F=t(g);F.__click=[ae,e];let S;n(g);var D=o(g,2),U=t(D);U.__click=[le,e];let R;n(D);var C=o(D,2),I=t(C);I.__click=[ce,e];let A;n(C);var T=o(C,2),P=t(T);P.__click=[pe,e];let q;n(T);var x=o(T,2),L=t(x);L.__click=[de,e];let E;n(x),n(u),n(a);var N=o(a,2),O=t(N);{var M=s=>{var r=ue(),i=o(t(r),16),d=t(i);d.textContent=`// firebase.js
...
{:else}
  <p>Please sign in</p>
{/if}`,n(i),n(r),y(s,r)};b(Y,s=>{f(e)==="stores"&&s(V)})}var X=o(Y,2);{var Z=s=>{var r=we(),i=o(t(r),6),d=t(i);d.textContent=`// Define your document type
type UserProfile = {
  name: string;
  email: string;
  photoURL?: string;
...
<FirestoreCollection query={tasksQuery}>
  {#snippet render(tasks)}
    ...
    {/each}
  {/snippet}
</FirestoreCollection>`,n(p);var z=o(p,6),ee=t(z);ee.textContent=`import { ReadonlyWithId } from 'fire-rune';
...
<FirestoreCollection query={tasksQuery}>
  {#snippet render(tasks)}
    ...
    {/each}
  {/snippet}
</FirestoreCollection>`,n(z),n(r),y(s,r)};b(X,s=>{f(e)==="typesafety"&&s(Z)})}n(N),se(2),n(h),ne((s,r,i,d,p,w)=>{m=j(c,1,"svelte-1ncwje1",null,m,s),S=j(F,1,"svelte-1ncwje1",null,S,r),R=j(U,1,"svelte-1ncwje1",null,R,i),A=j(I,1,"svelte-1ncwje1",null,A,d),q=j(P,1,"svelte-1ncwje1",null,q,p),E=j(L,1,"svelte-1ncwje1",null,E,w)},[()=>({active:f(e)==="overview"}),()=>({active:f(e)==="auth"}),()=>({active:f(e)==="firestore-doc"}),()=>({active:f(e)==="firestore-collection"}),()=>({active:f(e)==="stores"}),()=>({active:f(e)==="typesafety"})]),y(l,h)}re(["click"]);export{ke as component};
