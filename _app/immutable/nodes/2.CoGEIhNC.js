...
\r\f \v\uFEFF`];function ae(l,e,h){var a=""+l;if(h){for(var u in h)if(h[u])a=a?a+" "+u:u;else if(a.length)for(var v=u.length,c=0;(c=a.indexOf(u,c))>=0;){var m=c+v;(c===0||H.includes(a[c-1]))&&(m===a.length||H.includes(a[m]))?a=(c===0?"":a.substring(0,c))+a.substring(m+1):c=m}}return a===""?null:a}function j(l,e,h,a,u,v){var c=l.__className;if(z||c!==h||c===void 0){var m=ae(h,a,v);(!z||m!==l.getAttribute("class"))&&(m==null?l.removeAttribute("class"):l.className=m),l.__className=h}else if(v&&u!==v)for(var _ in v){var F=!!v[_];(u==null||F!==!!u[_])&&l.classList.toggle(_,F)}return v}var le=b('<meta name="description" content="A lightweight, declarative Svelte library for Firebase integration"/>'),ce=(l,e)=>k(e,"overview"),pe=(l,e)=>k(e,"auth"),de=(l,e)=>k(e,"firestore-doc"),ue=(l,e)=>k(e,"firestore-collection"),ve=(l,e)=>k(e,"stores"),fe=(l,e)=>k(e,"typesafety"),he=b(`<section id="overview" class="svelte-1ncwje1"><h2 class="svelte-1ncwje1">Overview</h2> <p>fire-rune provides reactive Svelte components to easily integrate Firebase Auth and
          ...
          multiple places.</p> <h3 class="svelte-1ncwje1">Available Stores</h3> <ul><li><code class="svelte-1ncwje1">userStore</code> - Reactive store for Firebase Auth user state</li> <li><code class="svelte-1ncwje1">documentStore</code> - Reactive store for a Firestore document</li> <li><code class="svelte-1ncwje1">collectionStore</code> - Reactive store for a Firestore collection query</li></ul> <h3 class="svelte-1ncwje1">Example</h3> <pre class="svelte-1ncwje1"><code class="svelte-1ncwje1"></code></pre></section>`),_e=b(`<section id="typesafety" class="svelte-1ncwje1"><h2 class="svelte-1ncwje1">Type Safety</h2> <p>fire-rune comes with full TypeScript support, ensuring that your Firestore data is
          properly typed throughout your application.</p> <h3 class="svelte-1ncwje1">Typed Documents</h3> <pre class="svelte-1ncwje1"><code class="svelte-1ncwje1"></code></pre> <h3 class="svelte-1ncwje1">Typed Collections</h3> <pre class="svelte-1ncwje1"><code class="svelte-1ncwje1"></code></pre> <h3 class="svelte-1ncwje1">ReadonlyWithId Type</h3> <p>The <code class="svelte-1ncwje1">ReadonlyWithId</code> type adds the document ID to your document type:</p> <pre class="svelte-1ncwje1"><code class="svelte-1ncwje1"></code></pre></section>`),ye=b('<main class="container svelte-1ncwje1"><header class="svelte-1ncwje1"><h1 class="svelte-1ncwje1">🔥 fire-rune</h1> <p>A lightweight, declarative Svelte library for Firebase integration</p> <div class="npm-badge svelte-1ncwje1"><code class="svelte-1ncwje1">npm install fire-rune firebase</code></div> <div class="badges svelte-1ncwje1"><a href="https://github.com/andrewthehan/fire-rune" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/github/stars/andrewthehan/fire-rune?style=social" alt="GitHub stars"/></a> <a href="https://www.npmjs.com/package/fire-rune" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/npm/v/fire-rune.svg" alt="npm version"/></a> <a href="https://github.com/andrewthehan/fire-rune/blob/main/LICENSE" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="MIT License"/></a></div></header> <nav class="svelte-1ncwje1"><ul class="svelte-1ncwje1"><li><button>Overview</button></li> <li><button>Authentication</button></li> <li><button>Firestore Documents</button></li> <li><button>Firestore Collections</button></li> <li><button>Using Stores</button></li> <li><button>Type Safety</button></li></ul></nav> <div class="content"><!> <!> <!> <!> <!> <!></div> <footer class="svelte-1ncwje1"><p><a href="https://github.com/andrewthehan/fire-rune" target="_blank" rel="noopener noreferrer" class="svelte-1ncwje1">GitHub</a> | <a href="https://www.npmjs.com/package/fire-rune" target="_blank" rel="noopener noreferrer" class="svelte-1ncwje1">NPM</a> | <a href="https://github.com/andrewthehan/fire-rune/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" class="svelte-1ncwje1">MIT License</a></p></footer></main>');function De(l){let e=te("overview");var h=ye();oe(t=>{var n=le();se.title="fire-rune",g(t,n)});var a=i(s(h),2),u=s(a),v=s(u),c=s(v);c.__click=[ce,e];let m;r(v);var _=i(v,2),F=s(_);F.__click=[pe,e];let S;r(_);var C=i(_,2),U=s(C);U.__click=[de,e];let I;r(C);var D=i(C,2),R=s(D);R.__click=[ue,e];let A;r(D);var T=i(D,2),P=s(T);P.__click=[ve,e];let q;r(T);var E=i(T,2),L=s(E);L.__click=[fe,e];let x;r(E),r(u),r(a);var N=i(a,2),Q=s(N);{var M=t=>{var n=he(),o=i(s(n),16),d=s(o);d.textContent=`// firebase.js
...
export const db = getFirestore(app);`,r(o),r(n),g(t,n)};y(Q,t=>{f(e)==="overview"&&t(M)})}var O=i(Q,2);{var G=t=>{var n=me(),o=i(s(n),6),d=s(o);d.textContent=`<script lang="ts">
...
<FirebaseUser {auth}>
  ...
  {#snippet loggedOut()}
    <p>Please sign in</p>
  {/snippet}
</FirebaseUser>`,r(p),r(n),g(t,n)};y(O,t=>{f(e)==="auth"&&t(G)})}var B=i(O,2);{var J=t=>{var n=we(),o=i(s(n),6),d=s(o);d.textContent=`<script lang="ts">
...
<FirestoreDoc ref={userRef}>
  ...
  {/snippet}
</FirestoreDoc>`,r(p),r(n),g(t,n)};y(B,t=>{f(e)==="firestore-doc"&&t(J)})}var W=i(B,2);{var K=t=>{var n=ge(),o=i(s(n),6),d=s(o);d.textContent=`<script lang="ts">
...
<FirestoreCollection query={tasksQuery}>
  ...
  {#snippet error(err)}
    <p>Error: {err.message}</p>
  {/snippet}
</FirestoreCollection>`,r(p),r(n),g(t,n)};y(W,t=>{f(e)==="firestore-collection"&&t(K)})}var Y=i(W,2);{var V=t=>{var n=be(),o=i(s(n),10),d=s(o);d.textContent=`<script lang="ts">
...
{:else}
  <p>Please sign in</p>
{/if}`,r(o),r(n),g(t,n)};y(Y,t=>{f(e)==="stores"&&t(V)})}var X=i(Y,2);{var Z=t=>{var n=_e(),o=i(s(n),6),d=s(o);d.textContent=`// Define your document type
type UserProfile = {
  name: string;
  email: string;
  photoURL?: string;
...
<FirestoreCollection query={tasksQuery}>
  {#snippet render(tasks)}
    ...
    {/each}
  {/snippet}
</FirestoreCollection>`,r($),r(n),g(t,n)};y(X,t=>{f(e)==="typesafety"&&t(Z)})}r(N),re(2),r(h),ne((t,n,o,d,p,w)=>{m=j(c,1,"svelte-1ncwje1",null,m,t),S=j(F,1,"svelte-1ncwje1",null,S,n),I=j(U,1,"svelte-1ncwje1",null,I,o),A=j(R,1,"svelte-1ncwje1",null,A,d),q=j(P,1,"svelte-1ncwje1",null,q,p),x=j(L,1,"svelte-1ncwje1",null,x,w)},[()=>({active:f(e)==="overview"}),()=>({active:f(e)==="auth"}),()=>({active:f(e)==="firestore-doc"}),()=>({active:f(e)==="firestore-collection"}),()=>({active:f(e)==="stores"}),()=>({active:f(e)==="typesafety"})]),g(l,h)}ie(["click"]);export{De as component};
